...
?>
  <tr class="trOdd">
	  <td height="26" align="right"><span class="required">*</span> <?php echo $heading_element_field_heading;?> :</td>
	  <td>
		<input type="text" name="<?php echo $heading_element_field_name;?>" value="<?php echo set_value($heading_element_field_name,$heading_element_field_value);?>"  placeholder="<?php echo $heading_element_field_placeholder;?>" <?php echo $heading_element_field_exparams;?> <?php if($heading_cat_id <=5 && $heading_cat_id!=''){ echo 'readonly="readonly"'; }?> /> <br />
  ...
  <tr class="trOdd">
	...
	<td>
	  <div class="seo_url">
		...
		{
		?>
		<input type="text" name="pre_seo_url" id="pre_seo_url" value="<?php echo $pre_seo_url;?>"  size="40" title="<?php echo $pre_seo_url;?>" <?php if($heading_cat_id <=5 && $heading_cat_id!=''){ echo 'readonly="readonly"'; }?> />
		<?php
		}
		?>
		<input type="text" name="<?php echo $url_element_field_name;?>" value="<?php echo set_value($url_element_field_name,$url_element_field_value);?>"  class="seo_friendly_url edit_url" placeholder="<?php echo $url_element_field_placeholder;?>" <?php echo  $url_element_field_exparams;?> <?php if($heading_cat_id <=5 && $heading_cat_id!=''){ echo 'readonly="readonly"'; }?> /> 
	  </div>
	  <div id="error_friendly_url" class="red"><?php echo form_error($url_element_field_name);?></div>
