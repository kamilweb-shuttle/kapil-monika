...
?>
  <tr class="trOdd">
	  <td height="26" align="right"><span class="required">*</span> <?php echo $heading_element_field_heading;?> :</td>
	  <td>
    <?php echo $heading_cat_id; ?>
		<input type="text" name="<?php echo $heading_element_field_name;?>" value="<?php echo set_value($heading_element_field_name,$heading_element_field_value);?>"  placeholder="<?php echo $heading_element_field_placeholder;?>" <?php echo $heading_element_field_exparams;?> <?php if($heading_cat_id <=5){ echo 'readonly="readonly"'; }?> /> <br />
