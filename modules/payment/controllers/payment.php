...
class Payment extends Public_Controller
{
      ...
      $this->page_section_ct = 'common';
		...
		public function index(){
			...
			//echo $this->input->get_post('pay_method');
			if($this->input->get_post('pay_method') == "paypal" )
			{	
			...
			elseif($this->input->get_post('pay_method') == "cod" )
			{

					$this->pay_by_check();							
			}
			else{
				$data  = array('payment_method'=>$this->input->get_post('pay_method'),'payment_status'=>'Unpaid');
		...
		public function pay_by_check(){
			...
			$this->session->set_flashdata('msg', 'Thank You For Your Order.<br/><br/>You can deposit funds via direct deposit or internet transfer.<br/><br/>We will ship as soon as cleared funds are in our account.<br/><br/>
 Our Bank Details Are-<br/><br/>ING Bank<br/><br/>BSB: 923 100<br/><br/>A/C: 70259531');	
  ...
  public function thanks(){
      ...
      $this->load->view('cart/view_cart_invoice', $data);
    }
	}
}
