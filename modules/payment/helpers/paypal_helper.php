...
function paypalForm($order_res)
{
	...
	$CI =& get_instance();
	$amount    = round( ($order_res['total_amount']) + ( $order_res['shipping_amount']) + ($order_res['vat_amount']) - ( $order_res['coupon_discount_amount']), 2);
...
<body style="margin:0px;">    
    <div style="text-align:left; font-size: 22px; font-weight:bold;  background-color:#f9f9f9; border:#efefef; padding:20px;">
		...
		<input type="hidden" name="business" value="cp.kleen-tech@hotmail.com"> 
