 ...
 <div class="box">
	...
	<table width="90%"  class="tableList" align="center">
		...
		<tr class="trOdd">
			...
			<td width="597">
        <input type="text" name="location_name" size="40" value="<?php echo set_value('location_name',$res->location_name);?>"></td>
		</tr>
        <tr class="trOdd">
			<td width="253" height="26"> Zip Code : <span class="required">*</span></td>
			<td width="597">
        <input type="text" name="zip_code" size="40" value="<?php echo set_value('zip_code',$res->zip_code);?>"></td>
		</tr>
    
    <tr class="trOdd">
			<td width="253" height="26"> COD Available : <span class="required">*</span></td>
			<td width="597">
      	<input type="radio" name="cod" value="N" <?php if($this->input->post('cod') == 'N' || $res->cod == 'N') echo 'checked="checked"'; ?> /> No &nbsp; 
