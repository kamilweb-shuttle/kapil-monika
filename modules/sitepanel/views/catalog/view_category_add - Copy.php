...
<div class="content">
  ...
  <div class="breadcrumb">
       <?php echo anchor('sitepanel/dashbord','Home'); ?>
        &raquo; <?php echo anchor('sitepanel/category'.($parent_id==0 ? '' : '/index/'.$parent_id),'Back To Listing'); ?> &raquo; <?php echo $heading_title; ?> </a>
	...
	<?php echo form_open_multipart("sitepanel/category/add/".$parent_id);?>  
		<div id="tab_pinfo">
			...
			$default_params = array(
								...
								'product_url_element'  => array(
														  'show_component' => TRUE,
														  'field_heading'=>"Product Page URL",
														  'field_name'=>"product_friendly_url",
														  'field_placeholder'=>"Product Page URL",
														  'exparams' => 'size="40"',
														  'pre_seo_url' =>'products',
														  'pre_url_tag'=>TRUE
													   )
			...
			if(is_array($parentData))
			{
			  ...
			  $pre_product_seo_url  = base_url().'products/'.$parentData['friendly_url']."/";
			  $default_params['product_url_element']['pre_seo_url'] = $pre_product_seo_url;
			  $default_params['product_url_element']['pre_url_tag'] = TRUE;
			  $default_params['product_url_element']['exparams'] = 'size="30"';
			}
            ...
            <tr class="trOdd">
				...
				<td align="left">
					<input type="text" name="category_alt" value="<?php echo set_value('category_alt');?>" />
					<br />
				</td>
			</tr>
            <tr class="trOdd">
