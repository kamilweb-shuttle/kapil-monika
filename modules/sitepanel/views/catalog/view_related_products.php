...
<table width="90%" align="left" cellpadding="1" cellspacing="1" class="list">
	<tr>
		<td>
			...
			<input name="remove_related" type="submit"  value="Remove related product" class="button2" id="Activate" onClick="return validcheckstatus('arr_ids[]','Remove related product','Record','u_status_arr[]');"/>
