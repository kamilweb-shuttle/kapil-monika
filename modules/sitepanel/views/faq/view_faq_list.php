<?php $this->load->view('includes/header'); ?>  
 ...
 <div class="box">
    ...
    <div class="heading">
     ...
     <?php 
	 echo form_open("sitepanel/faq/",'id="search_form" method="get"');?>
	   ...
	   <table width="100%"  border="0" cellspacing="3" cellpadding="3" >
                ...
                <tr>
					...
					<?php	
					 ...
					 { 
					    echo anchor("sitepanel/faq/",'<span>View All</span>');
					 }
					 ?>
        ...
        <tbody>
          ...
          <tr>
           ...
           <div id="dialog_<?php echo $pageVal['faq_id'];?>" title="Answer" style="display:none;"> <?php echo $pageVal['faq_answer'];?></div>
			...
			<?php echo anchor("sitepanel/faq/edit/$pageVal[faq_id]/",'Edit'); ?></td>
          </tr>
          <?php
		   }		  
		  ?> 
