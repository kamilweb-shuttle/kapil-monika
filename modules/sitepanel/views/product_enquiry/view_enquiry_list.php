...
$block_path=$inq_type=='Wholesale' ? "enquiry/wholesale/" : "product_enquiry/";
?>  
  ...
  <div class="breadcrumb">
    ...
    <div class="content">
     <?php  echo error_message(); ?>
		...
		<?php echo form_open("sitepanel/product_enquiry/",'id="search_form"');?>
		...
		<table width="100%"  border="0" cellspacing="3" cellpadding="3" >
         ...
         <tr>
			...
			{ 
				echo anchor("sitepanel/product_enquiry/",'<span>Clear Search</span>');
			} 
			?>
		   </td>
		</tr>
		...
		{
		?>
			<?php echo form_open("sitepanel/product_enquiry/",'id="data_form"');?>
			...
			?> 
				<tr>
					...
					{ 
						$address_details[]="<b>Mobile Number : </b>".$res['mobile_number'];  
					}
                    ...
                    <?php }?>
                    <br />
					<?php echo anchor_popup('sitepanel/product_enquiry/send_reply/'.$res['id'], 'Send Reply', $atts);?>
					</td>
