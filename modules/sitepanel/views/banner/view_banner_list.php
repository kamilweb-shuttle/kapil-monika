	...
	<div class="content">
		...
		if( is_array($res) && !empty($res) )
		{
			...
			<tr>
				...
				<td width="165" class="left">Banner Position</td>
				<td width="165" class="left">Section</td>
				<td width="150" class="left">Banner Picture</td>
        <td width="100" class="left">Banner URL</td>
				<td width="100" class="right">Status</td>
				<td width="100" class="right">Action</td>
			</tr>
			</thead>
			<tbody>
			<?php 	
