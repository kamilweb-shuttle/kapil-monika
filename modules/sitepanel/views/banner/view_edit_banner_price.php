...
<div class="box">
	...
	<div class="content">
		...
		?>
		<?php echo form_open_multipart('sitepanel/banners/edit_banner_price/'.$this->uri->segment(4));?>  
		<div id="tab_pinfo">
			...
			<!--<tr class="trOdd">
			  ...
			  <td align="left">
               ...
               <input type="radio" name="banner_type"  <?php if($res->banner_type=='image'){ ?> checked="checked" <?php } ?> value="image"/> Image  
          <input type="radio" name="banner_type" value="text" <?php if($res->banner_type=='text'){ ?> checked="checked" <?php } ?> /> Text 
              
              </td>
			  </tr>-->
			<tr class="trOdd">
			  <td height="26" align="right" ><span class="required">* </span>Price(<?php echo $this->config->item('currency_format');?>)  :</td>
			  <td align="left"><input type="text" name="banner_price" value="<?php echo set_value('',$res->banner_price);?>" size="50" /></td>
			  </tr>
			<tr class="trOdd">
				<td align="left">&nbsp;</td>
				<td align="left">
