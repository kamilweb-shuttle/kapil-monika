<?php $this->load->view("top_application");?>
	...
	<div class="breadcrumbs mob_hider">
  	<div class="wrapper">
    	<p class="ml5">YOU ARE HERE : <a href="<?php echo base_url(); ?>"><img src="<?php echo theme_url(); ?>images/hm.png" class="vam pb3" alt=""></a> <b>&gt;</b> <a href="<?php echo base_url(); ?>members/myaccount">My Account</a> <b>&gt;</b> <a href="<?php echo base_url(); ?>members/manage_addressed">My Addresses</a> <b>&gt;</b> <strong>Add</strong></p>
	  </div>
	</div>
          ...
          <!-- left ends -->
              ...
              <div class="short_form">
                ...
                <fieldset class="pb15" style="border:0;">
                  ...
                  <div class="w62">
                    <input name="name" id="name" value="<?php echo set_value('name',$res['name']);?>" type="text">
                  ...
                  <div class="w62">
                    <input name="mobile" id="mobile" value="<?php echo set_value('mobile',$res['mobile']);?>" type="text">
                  ...
                  <div class="w62">
                    <input name="phone" id="phone" value="<?php echo set_value('phone',$res['phone']);?>" type="text">
                  ...
                  <div class="w62">
                    <input name="zipcode" id="zipcode" value="<?php echo set_value('zipcode',$res['zipcode']);?>" type="text">
                  ...
                  <div class="w62">
                    <textarea name="address" rows="3" id="address"><?php echo set_value('address',$res['address']);?></textarea>
                  ...
                  <div class="w62">
                    <textarea name="landmark" rows="2" id="landmark"><?php echo set_value('landmark',$res['landmark']);?></textarea>
                  ...
                  <div class="w62">
                    <input name="city" id="city" value="<?php echo set_value('city',$res['city']);?>" type="text">
                  ...
                  <div class="w62">
                    <input name="state" id="state" value="<?php echo set_value('state',$res['state']);?>" type="text">
                  ...
                  <div class="w62">
                  	<?php echo CountrySelectBox(array('name'=>'country','format'=>'','current_selected_val'=>set_value('country',$res['country']) )); ?>
