        ...
        <ul class="nav nav-pills nav-top navbar-right">
            <li class="dropdown my-account">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="order-detail.html">My Orders</a></li>
                </ul>
            </li>
                ...
                <div class="dropdown-menu">
                    ...
                    <ul class="list-unstyled list-thumbs-pro">
                        ...
                        <li class="product">
                            <div class="product-thumb-info">
                                ...
                                <div class="product-thumb-info-content">
                                    <h4><a href="shop-product-detail1.html">Poplin shirt with fine pleated bands</a></h4>
                        ...
                        <div class="product-thumb-info">
                            <a href="#" class="product-remove"><i class="fa fa-trash-o"></i></a>
                                <div class="product-thumb-info-image">
                                    <a href="shop-product-detail1.html"><img alt="" width="60" src="<?php echo base_url(); ?>/assets/designer/images/content/products/product-3.jpg"></a>
                                </div>
                            <div class="product-thumb-info-content">
                                <h4><a href="shop-product-detail1.html">Contrasting shirt</a></h4>
                                <span class="item-cat"><small><a href="#">Jackets</a></small></span>
                                <span class="price">29.99 USD</span>
                            </div>
                        </div>
