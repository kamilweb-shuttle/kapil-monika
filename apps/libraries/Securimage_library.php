...
class CI_Securimage_library {
  ...
  public function initialize($mobile = false)
  {
    ...
    if (isset($securimage))
    {
		...
		$this->image_width = 120;$securimage['image_width'];
 ...
 public  function check($code)
  ...
  public function mobile()
  {
		...
		$this->CI->session->set_userdata('human_test_result', $result);
 ...
 public function saveData()
  {
	...
	$this->CI->session->set_userdata('securimage_code_value',$this->CI->session->userdata('human_test_result'));
  }
